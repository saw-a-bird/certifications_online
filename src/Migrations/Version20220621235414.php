 ...
 */
final class Version20220621235414 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE exam_paper DROP FOREIGN KEY FK_1CFF66A6B03A8386');
        $this->addSql('DROP INDEX IDX_1CFF66A6B03A8386 ON exam_paper');
        $this->addSql('ALTER TABLE exam_paper CHANGE exam_id exam_id INT DEFAULT NULL, CHANGE created_by_id suggested_by_id INT NOT NULL');
        $this->addSql('ALTER TABLE exam_paper ADD CONSTRAINT FK_1CFF66A666290AB1 FOREIGN KEY (suggested_by_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_1CFF66A666290AB1 ON exam_paper (suggested_by_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_1CFF66A666290AB1 ON exam_paper');
        $this->addSql('ALTER TABLE exam_paper CHANGE exam_id exam_id INT DEFAULT NULL, CHANGE suggested_by_id created_by_id INT NOT NULL');
        $this->addSql('ALTER TABLE exam_paper ADD CONSTRAINT FK_1CFF66A6B03A8386 FOREIGN KEY (created_by_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_1CFF66A6B03A8386 ON exam_paper (created_by_id)');
        $this->addSql('ALTER TABLE proposition CHANGE question_id question_id INT DEFAULT NULL');

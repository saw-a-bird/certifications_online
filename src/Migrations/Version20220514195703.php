 ...
 */
final class Version20220514195703 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE propositions CHANGE question_id question_id INT DEFAULT NULL, CHANGE is_correct is_correct TINYINT(1) DEFAULT \'0\' NOT NULL');
        $this->addSql('ALTER TABLE questions CHANGE task task TEXT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comments CHANGE written_on_id written_on_id INT DEFAULT NULL, CHANGE reply_to_id reply_to_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE exams CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE propositions CHANGE question_id question_id INT DEFAULT NULL, CHANGE is_correct is_correct TINYINT(1) NOT NULL');
        $this->addSql('ALTER TABLE questions CHANGE task task VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');

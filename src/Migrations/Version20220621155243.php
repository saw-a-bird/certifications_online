 ...
 */
final class Version20220621155243 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE exam ADD e_provider_id INT DEFAULT NULL, CHANGE certification_id certification_id INT DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE exam ADD CONSTRAINT FK_38BBA6C63393F3F4 FOREIGN KEY (e_provider_id) REFERENCES e_provider (id)');
        $this->addSql('CREATE INDEX IDX_38BBA6C63393F3F4 ON exam (e_provider_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_38BBA6C63393F3F4 ON exam');
        $this->addSql('ALTER TABLE exam DROP e_provider_id, CHANGE certification_id certification_id INT DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE exam_paper CHANGE exam_id exam_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE proposition CHANGE question_id question_id INT DEFAULT NULL');

 ...
 */
final class Version20220606073318 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE signaler ADD is_fixed TINYINT(1) NOT NULL, CHANGE created_by_id created_by_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE exams CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE propositions CHANGE question_id question_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE signaler DROP is_fixed, CHANGE created_by_id created_by_id INT DEFAULT NULL');

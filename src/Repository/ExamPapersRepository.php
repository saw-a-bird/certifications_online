 ...
 */
class ExamPapersRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(ExamPaper $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(ExamPaper $entity, bool $flush = true): void
    {
